...
public class Employee  implements Serializable{
	...
	public String toString() {
		return "Employee [id=" + id + ", employeecode=" + employeecode
				+ ", employeename=" + employeename + ", psw=" + psw
				+ ", pinyincode=" + pinyincode + ", wubicode=" + wubicode
				+ ", jobtitleid=" + jobtitleid + ", positionid=" + positionid
				+ ", sex=" + sex + ", tel=" + tel + ", departmentid="
				+ departmentid + ", email=" + email + ", idcard=" + idcard
				+ ", address=" + address + ", birthday=" + birthday
				+ ", inductiontime=" + inductiontime + ", dimissiontime="
				+ dimissiontime + ", maxeducationid=" + maxeducationid
				+ ", majorid=" + majorid + ", politicsstatusid="
				+ politicsstatusid + ", isoperator=" + isoperator
				+ ", isdoctor=" + isdoctor + ", isnurse=" + isnurse
				+ ", workstatus=" + workstatus + ", picture=" + picture
				+ ", note=" + note + ", isvalid=" + isvalid + "]";
	}
