...
<script type="text/javascript" src="http://localhost:8080/tnt/acssjsbymy/jquery.js"></script>
	...
	var websocket = null;
			if ('WebSocket' in window) {
			    websocket = new WebSocket("ws://localhost:8080/tnt/websocketsocketServer.do");
			}    
			else if ('MozWebSocket' in window) {
			    websocket = new MozWebSocket("ws://localhost:8080/tnt/websocketsocketServer.do");
			} 
			else {
			    websocket = new SockJS("http://localhost:8080/tnt/sockjssocketServer.do");
			}
    ...
    function onClose() {
    	alert("消息推送服务关闭提醒！");
    	//alert("guanbilainjieonClose(evt)");
   //  alert(evt.data);
     clock();
    ...
    function clock() {
		...
		if (i > 0){
			setTimeout("clock();", 1000);}
			   ...
			   window.location.href="${ctx}/jsp/user/login.jsp";
	}}
